//Steps are in reference to OneNote and ReadMe documentation. Cotinued from Step 9(Backend)

//Step 9. Setting up the Client (FE) - App.js//
import './App.css';
...
//Step 12. Create the registration and login function. Note that these functions are called in the button "onclick" within the forms //
  const register = (e) => {
    e.preventDefault();
